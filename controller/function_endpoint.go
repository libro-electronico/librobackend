...
func GetBooks(respw http.ResponseWriter, req *http.Request) {
	books, _ := chicken.GetAllDoc[[]model.Book](config.DB, "librobackend", bson.M{})
...
func CreateBook(respw http.ResponseWriter, req *http.Request) {
	...
	_, err = chicken.InsertOneDoc(config.DB, "librobackend", book)
	if err != nil {
		var respn model.Response
		respn.Response = err.Error()
		helper.WriteJSON(respw, http.StatusForbidden, respn)
	...
	books, err := chicken.GetAllDoc[[]model.Book](config.DB, "librobackend", bson.M{})
	if err != nil {
		var respn model.Response
		respn.Response = err.Error()
		helper.WriteJSON(respw, http.StatusForbidden, respn)
...
func UpdateBook(respw http.ResponseWriter, req *http.Request) {
	...
	dt, err := chicken.GetOneDoc[model.Book](config.DB, "librobackend", bson.M{"_id": book.ID})
	if err != nil {
		var respn model.Response
		respn.Response = err.Error()
		helper.WriteJSON(respw, http.StatusForbidden, respn)
	...
	_, err = chicken.ReplaceOneDoc(config.DB, "librobackend", bson.M{"_id": book.ID}, dt)
	if err != nil {
		var respn model.Response
		respn.Response = err.Error()
		helper.WriteJSON(respw, http.StatusForbidden, respn)
...
func DeleteBook(respw http.ResponseWriter, req *http.Request) {
	...
	_, err = chicken.DeleteOneDoc(config.DB, "librobackend", bson.M{"_id": book.ID})
	if err != nil {
		var respn model.Response
		respn.Response = err.Error()
		helper.WriteJSON(respw, http.StatusForbidden, respn)
